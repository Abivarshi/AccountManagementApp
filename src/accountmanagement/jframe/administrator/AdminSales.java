...
public class AdminSales extends javax.swing.JPanel {
     ...
     * @param shopName
     */
    public AdminSales(String shopName) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Book Out List");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 31, 100, 22));
        add(salesTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 30, 114, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String value = salesTextField.getText();
        ...
        if (!db.isColumnExist(shopName, "Sales", valueEdited)) {
            ...
            successLabel.setText("Sales added Successfully..");
        }else{
            salesTextField.setText("");
            warningLabel.setText("**Sales already exist.");
        }
