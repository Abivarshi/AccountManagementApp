 ...
 * @author acer
 */
public class BookOutDetailReport extends javax.swing.JPanel {
     ...
     * @param shopName
     */
    public BookOutDetailReport(String shopName, String tableName, String title, Map<String, String> colList) {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        System.out.println(size + " "+ colList.keySet());
        if (fromDate.compareTo(toDate) < 0 || fromDate.compareTo(toDate) == 0) {
            ...
            try {
                ...
                Logger.getLogger(BookOutDetailReport.class.getName()).log(Level.SEVERE, null, ex);
