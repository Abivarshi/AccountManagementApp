 ...
 * @author acer
 */
public class CombineColReport extends javax.swing.JPanel {
     ...
     * @param colList
     */
    public CombineColReport(String shopName, String tableName, String title, Map<String, String> colList) {
        ...
        if (fromDate.compareTo(toDate) < 0 || fromDate.compareTo(toDate) == 0) {
            ...
            try {
                ...
                if (!data.isEmpty()) {
                    ...
                    InputStream sourceName = getClass().getResourceAsStream("/accountmanagement/jframe/report/Report" + (size -1) + ".jrxml");
                ...
                Logger.getLogger(CombineColReport.class.getName()).log(Level.SEVERE, null, ex);
