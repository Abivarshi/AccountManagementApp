 ...
 * @author acer
 */
public class TotalPayoutReport extends javax.swing.JPanel {
     ...
     * @param colName
     */
    public TotalPayoutReport(String shopName, String title, List<String> colName) {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if (fromDate.compareTo(toDate) < 0 || fromDate.compareTo(toDate) == 0) {
            ...
            try {
                ...
                String sourceName = new File("").getAbsolutePath() + "/src/accountmanagement/jframe/report/till/TotalPayoutReport.jrxml";
                ...
                Logger.getLogger(TotalPayoutReport.class.getName()).log(Level.SEVERE, null, ex);
            }
