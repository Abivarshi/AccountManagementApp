 ...
 * @author acer
 */
public class VoucherReport extends javax.swing.JPanel {
     ...
     * @param colName
     */
    public VoucherReport(String shopName, String title, List<String> colName) {
...
//                    dataValue.put("From Back Office Total",String.valueOf(Float.parseFloat(res.getString(colName.get(2)))+Float.parseFloat(res.getString(colName.get(3)))) );
                ...
                Logger.getLogger(VoucherReport.class.getName()).log(Level.SEVERE, null, ex);
            }
