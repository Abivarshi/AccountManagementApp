...
public class StaffSalary extends javax.swing.JPanel {
     ...
     * @param col
     */
    public StaffSalary(String shopName, String title, String col) {
        ...
        if (fromDate.compareTo(toDate) < 0 || fromDate.compareTo(toDate) == 0) {
            ...
            try {
                ...
                for (String staff : staffList.keySet()) {
                    ResultSet res = db.getStaffSummary(shopName, staff, fromDate, toDate);
                    if (i == 0) {
                        while (res.next()) {
                ...
                for (String date : dataVal.keySet()) {
                    ...
                    int j = 0;
                    for (String colName : staffList.keySet()) {
                        if (val[j] == null) {
                            map.put("Col" + (j + 1), "");
                        } else
                            map.put("Col" + (j + 1), Float.toString(val[j]));
                        map.put("ColName" + (j + 1), staffList.get(colName));
                        j = j + 1;
                    }
                ...
                if (!data.isEmpty()) {
                    ...
                    InputStream sourceName = getClass().getResourceAsStream("/accountmanagement/jframe/report/Report"+size+".jrxml");
